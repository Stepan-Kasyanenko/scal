...
var map = {
	...
	"app/main/modules/feature1/feature1.module": [
		"../../../../../src/app/main/modules/feature1/feature1.module.ts",
		"feature1.module"
	],
	"app/main/modules/feature2/feature2.module": [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_login_service__ = __webpack_require__("../../../../../src/app/core/services/login.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__guards_auth_guard__ = __webpack_require__("../../../../../src/app/core/guards/auth.guard.ts");
...
CoreModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* NgModule */])({
        ...
        declarations: [],
        providers: [__WEBPACK_IMPORTED_MODULE_1__services_login_service__["a" /* LoginService */], __WEBPACK_IMPORTED_MODULE_2__guards_auth_guard__["a" /* AuthGuard */]]
    })
], CoreModule);
...
var AuthGuard = (function () {
    ...
    AuthGuard.prototype.canActivate = function (next, state) {
        var isAuth = this.loginService.isAuth();
        if (isAuth) {
            return true;
        }
        else {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve) {
                        ...
                        setTimeout(function () {
                            ...
                            window.localStorage.setItem(_this.authKey, _this.authToken);
                            resolve(true);
                        }, 1000);
                    })];
            });
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve) {
                        ...
                        setTimeout(function () {
                            ...
                            window.localStorage.removeItem(_this.authKey);
                            resolve(true);
                        }, 1000);
                    })];
            });
